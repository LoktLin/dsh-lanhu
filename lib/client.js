...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function AccountRow(props) {
			...
			const toggle = () => set({ openAccount: open ? null : a.alias });
				...
				open ? React.createElement('div', {
					...
					React.createElement('div', { style: { display: 'flex', flexWrap: 'wrap', gap: '6px', marginTop: '8px' } },
						...
						React.createElement(Btn, {
							...
							onClick: () => set({ adding: true, draftAlias: a.alias, draftCompany: a.company || '' }),
						}),
						React.createElement(Btn, {
							label: '删除', disabled: busy,
							onClick: () => accountAction('remove', { alias: a.alias }),
						}),
					),
				) : null,
			);
			...
			return React.createElement('div', null,
				...
				d ? React.createElement('div', { style: { marginTop: '10px' } },
					...
					React.createElement('div', {
						...
						style: { maxHeight: '38vh', overflowY: 'auto', overscrollBehavior: 'contain', border: '1px solid ' + C.borderSoft, borderRadius: '6px', padding: '0 6px' },
					}, shown.length === 0
		...
		function LogTab(props) {
			...
			return React.createElement('div', null,
				...
				React.createElement('div', {
					...
					style: { maxHeight: '46vh', overflowY: 'auto', overscrollBehavior: 'contain' },
				}, entries.length === 0
			...
			return React.createElement('div', {
				...
				React.createElement('div', {
					...
					React.createElement('button', {
						...
						style: { border: 'none', background: 'transparent', color: C.dim, cursor: 'pointer', font: 'inherit', fontSize: '16px', lineHeight: '1', padding: '0 2px' },
					}, '×'),
				),
				// Tab 条
				React.createElement('div', {
